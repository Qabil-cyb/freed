                  ...
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: colors.neon,
                        side: BorderSide(color: colors.neon),
                        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                      ),
...
class _EditUserDialogState extends State<EditUserDialog> {
  ...
  late TextEditingController _trafficLimitController;
  late TextEditingController _daysLimitController;
  late TextEditingController _ipLimitController;
  List<Inbound> _inbounds = [];
  int? _selectedInboundId;
  bool _isLoading = false;
  ...
  void initState() {
    ...
    _trafficLimitController = TextEditingController(
        text: (widget.user.trafficLimit / (1024 * 1024 * 1024)).toStringAsFixed(0));
